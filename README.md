...
See [docs/marketplace-roadmap.md](docs/marketplace-roadmap.md) for the open-core boundary, [docs/development-to-marketplace-release.md](docs/development-to-marketplace-release.md) for the release plan, and [docs/agent-issue-backlog.md](docs/agent-issue-backlog.md) for the current implementation backlog.
